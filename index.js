...
function handleAutoStartChange() {
  if (autostart) {
    ...
    if (!fs.existsSync(snapUserData + '/.config/autostart/deepseek-desktop.desktop')) {
      fs.copyFileSync(snapPath + '/com.github.kenvandine.deepseek-desktop-autostart.desktop', snapUserData + '/.config/autostart/deepseek-desktop.desktop');
    }
  } else {
    console.log("Disabling autostart");
    if (fs.existsSync(snapUserData + '/.config/autostart/deepseek-desktop.desktop')) {
      fs.rmSync(snapUserData + '/.config/autostart/deepseek-desktop.desktop');
    }
  }
}
